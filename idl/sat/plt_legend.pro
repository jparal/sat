...
;       background = color for background clearing
...
;-
pro plt_legend, items, BOTTOM_LEGEND=bottom, BOX = box, CENTER_LEGEND=center, $
    CHARTHICK=charthick, CHARSIZE = charsize, CLEAR = clear, $
    BACKGROUND = background, COLORS = colorsi, $
