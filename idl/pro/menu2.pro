...
'"qx"','}','"R-H" {', $ 
     ...
     '"et1"','"et2"',$
      '}', '"Quit"'], rcol
  xmenu, ['Slicer','Contour','Image_cont','Image_cont1', $
    'Surface','Shade_surf','Image', $
    'Vector','Plot','Oplot'],/exclusive,/Frame,rcol
  mmm=widget_base(rcol,/column)
  mmm1=widget_base(mmm,/row)
  xmenu, ['xy','xz','yz'],/exclusive,/Frame,mmm1
  xmenu, ['x','y','z'],/exclusive,/Frame,mmm1
  xmenu, ['FFT','No FFT'],/exclusive,/Frame,mmm1
  xmenu, ['1','2x1','1x2','3x1','1x3','1x4','2x2'],/exclusive,/Frame,mmm1
