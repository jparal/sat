; image_cont modified
pro im, a, WINDOW_SCALE = window_scale, ASPECT = aspect, $
INTERP = interp,NOERASE=noerase,_EXTRA=extra 
;+
; NAME:
;	IM
;
; PURPOSE:
;	Create an image with a contour-like border.
;
; CATEGORY:
;	General graphics.
;
...
;	Hellinger, February, 1995
;-

on_error,2                      ;Return to caller if an error occurs
a=reform(a)                     ;Reform array 
...
contour,a,/nodata,/noerase,/xst,/yst,$	;Do the contour
	   pos = [px(0),py(0), px(0)+swx,py(0)+swy],/dev,$
	c_color =  colors,_EXTRA=extra
;+
return
end
