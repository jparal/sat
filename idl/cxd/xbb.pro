...
;         Once created the widget width is fixed.  Use something
;         like a line of dashes to set the initial width (spaces
;         do not work as well).
...
;-------------------------------------------------------------
	...
	if keyword_set(hlp) or n_elements(lines) eq 0 then begin
	  ...
	  print,'   Once created the widget width is fixed.  Use something'
	  print,'   like a line of dashes to set the initial width (spaces'
	  print,'   do not work as well).'
	  return
	endif
	...
	for i = 0, n_elements(lines)-1 do begin
	  id = widget_label(top, val=lines(i))
