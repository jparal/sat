...
;    a = read_sam(file)
path='/media/wind/rsi/fft/samnet/data/19910324/'
file = path +'bfa'
print, file
X1 = dblarr(17280)
X2 = dblarr(17280)
   ...
   openr, inlun, file, /get_lun, error = err
...
print, line
   ...
   for i =1, 720 do begin

        readF , inlun, dum21, dum22, dum23

        if dum21 lt 99990 then begin
...
endwhile
    ...
    T = 5 ;a.data_params.samp_int ; sampling interval in seconds
    print, 'Sample interval = ', T;1
    ;h=a.data_vals.h
    ;d=a.data_vals.d
        h = X1
        d = X2
