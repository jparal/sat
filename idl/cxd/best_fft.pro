...
; KEYWORD PARAMETERS:
;       Keywords:
;         DELTA=d  The range half width: n-d to n+d, in samples.
;           Default = 1.
...
;-------------------------------------------------------------
	...
	function best_fft, n, delta=delta, percent=percent, help=hlp
	...
	if (n_params(0) lt 1) or keyword_set(hlp) then begin
	  ...
	  print,' Keywords:'
	  print,'   DELTA=d  The range half width: n-d to n+d, in samples.'
	  print,'     Default = 1.'
	...
	for i=0,n-1 do begin			; Loop through numbers.
	  factor,arr(i),pp,nn			; Factor each.
