...
;*************************************************
PRO idlcxd_goes;,ii,hour,mins,nmins,hicut,lowcut
...
array_name_index= 3;0;4;5;1;5;1;2;4;2;1;4;1;3  ;*****change 1
...
case strupcase(strtrim(array_name,1)) of
 ...
 'IMAGE' :Xstatn=utl_input_image2(data_file,points)
 'SAMNET':Xstatn=utl_input_samnet(data_file)
 'GOES' :Xstatn=gsm2fac(data_file,lnum1);utl_input_goes(data_file,Points)
 'LANL':Xstatn= utl_input_lanl(data_file,Points)
 'INTERMAG' : Xstatn= utl_input_intermag(data_file);,Points)	;210(data_file,Points);intermag(data_file,Points)	
endcase
...
; plot,TimeFile/60./60.,Xstatn.X3,XStyle=1,xticks=3,ystyle=1,xtitle ='Time (UT)',$
...
endelse
	...
	T = Sint; a.data_params.samp_int	; sampling interval in seconds
