...
; INPUTS:
;       a = major axis of ellipse (data units).                      in
;       b = minor axis of ellipse (data units).                      in
...
;  doc_library,'ellipse'
  ...
  print,'   a = major axis of ellipse (data units).                      in
  print,'   b = minor axis of ellipse (data units).                      in
