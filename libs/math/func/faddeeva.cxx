...
complex<double> Faddeeva (const complex<double>& z)
{
    ...
    if ((xabs > rmaxreal) || (yabs > rmaxreal)) {
      printf ("Faddeeva1: absolute value of argument large, w(z) overflows\n");
      printf ("Faddeeva1: z = (%lf,%lf)\n",xi, yi);
      return NAN;
    }
    ...
    if (yi < 0.0) {
        ...
        if (a) {
            ...
            if ((yquad > rmaxgoni) || (xquad > rmaxexp)) {
              printf ("Faddeeva2: absolute value of argument large, w(z) overflows\n");
	      return NAN;
            }
